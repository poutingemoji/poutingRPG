  ...
  constructor(client) {
    super(client, {
      ...
      args: [
        {
          key: "place",
          prompt: "What place would you like to get weather info from?",
          type: "string",
        },
      ],
      throttling: {
    ...
    try {
      ...
      const messageEmbed = new MessageEmbed()
        ...
        .setAuthor(
          `${weatherInfo["name"]}${
            !weatherInfo["sys"]["country"]
              ? ""
              : `, ${getCountryName(weatherInfo["sys"]["country"])}`
          }`
        )
        .setThumbnail(
        ...
        .addFields(
          {
            name: "Temperature\n(Actual/Feels Like)",
            value: `${weatherInfo["main"]["temp"]}°F/${weatherInfo["main"]["feels_like"]}°F`,
          },
          {
            name: "Current Weather",
            value: titleCase(currentWeather["description"]),
          },
          {
            name: "Humidity",
          ...
          },
          {
            ...
            value:
              ...
              " mph " +
              getCardinalDirection(weatherInfo["wind"]["deg"]),
            inline: true,
          }
        );
...
function getCardinalDirection(angle) {
  ...
  const arrows = {
    north: "N :arrow_up:",
    north_east: "NE :arrow_upper_right:",
    east: "E :arrow_right:",
    south_east: "SE :arrow_lower_right:",
    south: "S :arrow_down: ",
    south_west: "SW :arrow_lower_left:",
    west: "W :arrow_left:",
    north_west: "NW :arrow_upper_left:",
  };
