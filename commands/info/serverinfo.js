  ...
  run(msg) {
    ...
    const messageEmbed = new MessageEmbed()
      ...
      .addFields(
        ...
        {
          name: "Created",
          value: dateFormat(guild.createdAt, "dddd, mmmm dS, yyyy, h:MM:ss TT"),
        },
        { name: "Region", value: guild.region, inline: true },
        {
          name: "Members\n(Total/Online/Offline)",
          value: guild.memberCount + "/" + membersOnline + "/" + membersOffline,
        },
        {
          name: "Channels\n(Text/Voice)",
          value: textChannelCount + "/" + voiceChannelCount,
        },
        {
          name: "Humans/Bots",
          value: humanCount + "/" + botCount,
          inline: true,
        }
      )
      .setTimestamp()
